...
def convert_data(rarity):
    ...
    for i in range(0, total_cnt):
        ...
        new_json_data = {
            "name": f"CDSNFT-Field-{rarity} #{i + 1}",
            "description": f"{rarity} Field Token #{i + 1}",
            "external_url": "",
            ...
            "attributes": [
                {
                    ...
                    "trait_type": "building",
                    "value": str(json_data["building"]["imageName"])
                }, {
                    "trait_type": "animal",
                    "value": str(json_data["animal"]["imageName"])
                }, {
                    "trait_type": "chill",
                    "value": str(json_data["chill"]["imageName"])
                }, {
                    "trait_type": "vehicle",
                    "value": str(json_data["vehicle"]["imageName"])
                }, {
                    "trait_type": "special",
                    "value": str(json_data["special"]["imageName"])
                }, {
                    "trait_type": "border",
